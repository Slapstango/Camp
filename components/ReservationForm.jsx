...
export default function ReservationForm() {
  ...
  return (
    <div className="p-4 max-w-xl mx-auto bg-white shadow rounded">
      ...
      {step === 5 && <Step5UnitLength reservation={reservation} setReservation={setReservation} nextStep={nextStep} prevStep={prevStep} />}
      {step === 6 && <Step6GuestCount reservation={reservation} setReservation={setReservation} nextStep={nextStep} prevStep={prevStep} />}
      {step === 7 && <Step7GuestDetails reservation={reservation} setReservation={setReservation} nextStep={nextStep} prevStep={prevStep} />}
      {step === 8 && <Step8ReviewSubmit reservation={reservation} prevStep={prevStep} />}
    </div>
  );
}